...
def ResNet18_1(num_classes):
    num_blocks = [2, 2, 2, 2]
    return ResNet(BasicBlock, num_blocks, num_classes=num_classes, width_multiplier=1)


def ResNet18_2(num_classes):
    num_blocks = [2, 2, 2, 2]
    return ResNet(BasicBlock, num_blocks, num_classes=num_classes, width_multiplier=2)


def ResNet18_3(num_classes):
    num_blocks = [2, 2, 2, 2]
    return ResNet(BasicBlock, num_blocks, num_classes=num_classes, width_multiplier=3)


def ResNet50_1(num_classes):
    num_blocks = [3, 4, 6, 3]
    return ResNet(Bottleneck, num_blocks, num_classes=num_classes, width_multiplier=1)

def ResNet50_2(num_classes):
    num_blocks = [3, 4, 6, 3]
    return ResNet(Bottleneck, num_blocks, num_classes=num_classes, width_multiplier=2)

def ResNet152_05(num_classes):
    num_blocks = [3, 8, 36, 3]
    return ResNet(Bottleneck, num_blocks, num_classes=num_classes, width_multiplier=0.5)

def ResNet152_1(num_classes):
    num_blocks = [3, 8, 36, 3]
    return ResNet(Bottleneck, num_blocks, num_classes=num_classes, width_multiplier=1)
